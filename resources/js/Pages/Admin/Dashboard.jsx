...
export default function Dashboard({ auth ,totalNews}) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
        ...
        >
            ...
            <div className=" flex gap-8   ">
                <div className="bg-white overflow-hidden w-3/5 shadow-sm h-fit sm:rounded-lg p-6 flex flex-col gap-3">
                    ...
                    <div className=" w-full grid grid-cols-3 grid-rows-1 gap-4">
                        <div className="w-full aspect-square  rounded p-3 flex flex-col gap-2">
                            <Icon icon={'material-symbols:news'} className="text-5xl text-primary-orange"/>
                            <h3 className="font-semibold">Berita</h3>
                            <p className="text-xl font-semibold">{totalNews} Postingan</p>
                        ...
                        <div className="w-full aspect-square  rounded p-3 flex flex-col gap-2">
                            <Icon icon={'ic:round-people'} className="text-5xl text-primary-orange"/>
                            <h3 className="font-semibold">Perangkat Desa</h3>
                            <p className="text-xl font-semibold">10 Postingan</p>
                ...
                <div className="bg-white h-fit overflow-hidden w-2/5 shadow-sm sm:rounded-lg p-6 flex flex-col gap-4">
                    ...
                    <img src={Logo} alt="logo" draggable='false' className="w-2/5 mx-auto" />
                    <hr />
                    <div className="text-sm prose-sm text-balance">
                    <p>
                        Selamat datang di Dashboard CMS Kuningan! Sistem ini
                        dirancang untuk mempermudah pengelolaan konten dan
                        informasi di Desa Kuningan. Dengan menggunakan
                        platform ini, Anda dapat dengan mudah mengatur,
                        memperbarui, dan mempublikasikan berbagai informasi yang
                        berkaitan dengan kegiatan dan layanan di Kuningan.
                    </p>
               
                    <p>
                        Selamat bekerja dan mari kita bersama-sama membangun
                        Kuningan yang lebih baik!
                    </p>
